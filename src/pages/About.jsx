    ...
    return (
        <div className='w-full  p-4 flex flex-col justify-center items-center'>
            ...
            <div className='flex flex-col items-center justify-center gap-4 py-8'>
                ...
                <ol className="relative border-s border-gray-200 dark:border-gray-700 w-[90%] lg:w-1/2">
                    <li className="mb-10 ms-4">
                        <div className="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                        <time className="mb-1 text-sm font-normal leading-none text-gray-700 ">Aug 2023 - Nov 2023</time>
                        <h3 className="text-lg font-semibold text-gray-900 ">Frontend Developer at AiChefMaster </h3>
                        <p className="mb-4 text-base font-normal text-gray-700 ">Led the complete frontend development and UI design of dashboard webpage of the company, implementing
                            optimization strategies and adhering to industry best practices, resulting in a highly responsive site with efficient
                            load times.
                        </p>
                        <a target='_blank' href="https://drive.google.com/file/d/1Al1xt4Zo0nGk9jy9suKh2SqGQfD9YyY3/view?usp=sharing" className="inline-flex items-center px-4 py-2 text-sm font-medium bg-zinc-800 text-white bg-white border border-gray-200 rounded-lg ">Learn more <svg className="w-3 h-3 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
