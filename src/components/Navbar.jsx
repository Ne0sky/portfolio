...
const NavBar = () => {
  ...
  return (
    ...
    animate={{ y: isVisible ? 0 : 100 }}
      ...
      className='fixed text-white  bottom-15 left-1/2 transform -translate-x-1/2  max-w-full flex justify-center items-center w-[95%] lg:w-[500px] bg-indigo-800 border-indigo-500 border p-2 backdrop-filter backdrop-blur-sm bg-opacity-60 rounded-xl'
    >
