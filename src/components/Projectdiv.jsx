  ...
  return (
    <div className={`${obj.id % 2 === 0 ? 'lg:flex-row-reverse' : 'lg:flex-row'} px-2 md:px-4 lg:px-24 flex flex-col items-center py-8 gap-4`}>
          ...
          <div className='w-[90%] lg:w-1/2 font-tertiary'>
            <h3 className='text-3xl font-bold font-tertiary text-zinc-800'>{obj.title}</h3>
           ...
           <a target='_blank' href={obj.live} className='p-2 bg-lime-500  font-medium rounded flex  gap-2 items-center'>Live  <TbWorld/></a>
           <a target='_blank' href={obj.github} className='p-2  bg-indigo-500 font-medium rounded flex  gap-2 items-center '> code <FaGithub/></a>
           </div>
